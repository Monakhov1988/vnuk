...
- `chatWithGrandchild` — GPT-4o-mini с **function calling** (tools), глубокая персона «Внучок»:
  ...
  - **Function calling tools:**
    ...
    - `search_web(query)` — реальный веб-поиск через DuckDuckGo HTML + пересказ GPT-4o-mini (кино, ТВ, праздники, новости, льготы, пенсия, аптеки). Fallback на умный GPT если DDG заблокирован
