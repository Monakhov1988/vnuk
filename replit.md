...
- **TTS (Text-to-Speech)**: tts-1 (голос nova, формат opus) — верное воспроизведение текста без генеративного дрифта. STT — whisper-1 с verbose_json и quality gate (low/medium/high confidence)
    ...
    - `search_gov_services(query)` — пенсии, льготы, субсидии, санатории, путёвки через Perplexity. Упоминает оформление через соцработника. Источники: gosuslugi.ru, sfr.gov.ru, consultant.ru. Актуальные суммы и порядок оформления
