...
function detectRequiredTool(message: string): string | null {
  ...
  const searchWords = ["новости", "что произошло", "событи", "что случилось", "расскажи про ", "афиш", "театр", "кино", "фильм", "куда сходить", "что посмотреть", "концерт", "выставк", "мероприят", "премьер", "расписани", "какой сегодня", "праздник"];
