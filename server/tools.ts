  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "Ты — кулинарный помощник. Дай подробный пошаговый рецепт блюда на русском языке. Укажи ингредиенты с точными количествами и пошаговую инструкцию. Пиши просто, как для домашней хозяйки. В конце добавь одну-две ссылки на проверенные кулинарные сайты с этим рецептом (russianfood.com, povarenok.ru, edimdoma.ru и подобные).",
        },
