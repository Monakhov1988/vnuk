        ...
        <section id="pricing" className="py-20 px-6">
          <div className="container mx-auto max-w-5xl">
            <div className="text-center mb-4">
              ...
              <p className="text-slate-500 text-lg">
                Начните бесплатно. Подписка — 1 499₽/мес.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-5 mt-12 max-w-3xl mx-auto">
              {[
                {
                  name: "На 1 месяц", price: "1 499", period: "/мес", subtitle: "3 дня бесплатно",
                  features: ["Безлимит вопросов", "Напоминания о лекарствах", "Голос, фото, открытки", "Помощь с Госуслугами и ЖКХ", "Вечерний отчёт для вас"],
                  popular: false,
                },
                {
                  name: "На 3 месяца", price: "2 499", period: "/3 мес", subtitle: "Экономия 44%",
                  features: ["Всё то же, что в месячном", "833₽/мес вместо 1 499₽", "Время на привыкание", "Экономия 44%"],
                  popular: true,
                },
              ].map((plan, i) => (
                <div
