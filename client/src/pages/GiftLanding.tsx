          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex md:grid md:grid-cols-2 gap-6 max-w-4xl mx-auto overflow-x-auto snap-x snap-mandatory -mx-6 px-6 md:mx-auto md:px-0 md:overflow-visible scrollbar-hide">
              <DialogCard
                ...
                messages={[
                  { from: "bot", text: "Доброе утро! Не забудь выпить эналаприл 💊 Как спалось?" },
                  { from: "user", text: "Выпила. Спалось хорошо, только спина побаливает" },
                  { from: "bot", text: "Записал ✓ Давление мерила сегодня? А для спины — лёгкая разминка помогает, показать упражнения?" },
                  { from: "user", text: "🎤 «Сто тридцать на восемьдесят пять»" },
                  { from: "bot", text: "130/85 — в норме! Записал. Дочке вечером отправлю отчёт 💛" },
                ]}
              />
              <DialogCard
                ...
                messages={[
                  ...
                  { from: "bot", text: "О, из курицы много вкусного! Что больше хочешь — котлетки, запеканку, что-то в духовке или на сковородке? 🍗" },
                  { from: "user", text: "Давай в духовке, чтоб не стоять у плиты" },
                  { from: "bot", text: "Нашёл отличный рецепт! Курица с картошкой в духовке — всё на одном противне. Нужно: филе 500г, картошка 4-5 шт, сметана, чеснок. Рассказать пошагово?" },
                  { from: "user", text: "Давай! А сметану можно майонезом заменить?" },
                  { from: "bot", text: "Можно, но со сметаной нежнее получается. Итак, шаг 1: нарежь филе крупными кусками, посоли..." },
                ]}
              />
            </div>
